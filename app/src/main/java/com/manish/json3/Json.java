...
/**
 * Created by manishhp on 6/27/2017.
 */

public class Json extends Activity{
    static float amag[]={};
    static String aplace[]={};
    static long atime[]={};
    float mag;
    String place;
    long time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayList aljson = new ArrayList();
        try
        {
            ...
            for(int i = 0;i<10;i++)
            {
                JSONObject jsonobj1= ja.getJSONObject(i);
                JSONObject jsonobj2 = jsonobj1.getJSONObject("properties");
                mag = (float) jsonobj2.getDouble("mag");
                place = jsonobj2.getString("place");
                time = jsonobj2.getLong("time");
